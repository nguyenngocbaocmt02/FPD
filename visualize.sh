...
python visualize_src/limited_queries_performance_table.py results/ figures/limited_queries_performance_table.csv

python visualize_src/limited_queries_performance_type_table.py results/ figures/limited_queries_performance_type_table.csv